...
const getCharacterTimeLine = async (characterName: string, serverId: string, option: TimelineOption = {}): Promise<TimeLineApiResponse> => {
  ...
  return await axios
    .get<TimeLineApiResponse>(url)
    .then(response => response.data);
}

export { getCharacterTimeLine };